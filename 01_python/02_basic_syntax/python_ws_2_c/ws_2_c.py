...
path = data[0]['results'][0]['properties']
value = path['단계']['select']['name']
first_data = {}
first_data = {'제목': path['제목']['title'][0]['text']['content'], '일차' : int(path['일차']['number']), '단계' : value+'단계', '과목' : path['과목']['multi_select'][0]['name']}
print(first_data)